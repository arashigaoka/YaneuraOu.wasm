...
#else
// YaneuraOu.wasm WASM SIMDを使用するため、__builtin_popcountをcallするよう修正
...
#elif defined(__GNUC__) && ( defined(__i386__) || defined(__x86_64__) || defined(__ANDROID__) || defined(__EMSCRIPTEN__))

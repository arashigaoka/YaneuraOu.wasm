...
var Module = typeof YaneuraOu !== "undefined" ? YaneuraOu : {};
...
if (!Object.getOwnPropertyDescriptor(Module["ready"], "_usi_command")) {
 Object.defineProperty(Module["ready"], "_usi_command", {
  configurable: true,
  get: function() {
   abort("You are getting _usi_command on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
 Object.defineProperty(Module["ready"], "_usi_command", {
  configurable: true,
  set: function() {
   abort("You are setting _usi_command on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
}
...
(function() {
 var loadPackage = function(metadata) {
  ...
  var PACKAGE_NAME = "yaneuraou.data";
  var REMOTE_PACKAGE_BASE = "yaneuraou.data";
  ...
  function runWithFS() {
   ...
   Module["FS_createPath"]("/", "eval", true, true);
   ...
   function processPackageData(arrayBuffer) {
    ...
    Module["removeRunDependency"]("datafile_yaneuraou.data");
   }
   Module["addRunDependency"]("datafile_yaneuraou.data");
 ...
 loadPackage({
  "files": [ {
   "filename": "/eval/nn.bin",
   "start": 0,
   "end": 893917,
   "audio": 0
  } ],
  "remote_package_size": 893917,
  "package_uuid": "7fcc7fa3-7c6c-4ece-bc18-83b6c5614475"
 });
})();
...
(function() {
 ...
 function poll() {
  ...
  var tryLater = Module["ccall"]("usi_command", "number", [ "string" ], [ command ]);
...
var wasmBinaryFile = "yaneuraou.wasm";
...
var PThread = {
 ...
 allocateUnusedWorker: function() {
  var pthreadMainJs = locateFile("yaneuraou.worker.js");
...
var proxiedFunctionTable = [ null, _atexit, ___sys_fcntl64, ___sys_getcwd, ___sys_ioctl, ___sys_open, _emscripten_set_canvas_element_size_main_thread, _environ_get, _environ_sizes_get, _fd_close, _fd_read, _fd_seek, _fd_write ];
...
var _usi_command = Module["_usi_command"] = createExportWrapper("usi_command");
...
var __emscripten_allow_main_runtime_queued_calls = Module["__emscripten_allow_main_runtime_queued_calls"] = 25248;

var __emscripten_main_thread_futex = Module["__emscripten_main_thread_futex"] = 8755876;
